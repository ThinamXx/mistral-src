...
class RotatingBufferCache:
    ...
    def __init__(
        ...
        print(f"Allocated cache of size {self.cache_k.shape}")
        print(f"Allocated cache of size {self.cache_v.shape}")
    ...
    def reset(self):
        print("KV seqlens reset")
        self.kv_seqlens = None

    def init_kvseqlens(self, batch_size: int):
        print(f"Initializing kv_seqlens with size {batch_size}")
    ...
    def get_input_metadata(self, seqlens: List[int]) -> RotatingCacheInputMetadata:
        ...
        print(f"to_cache_mask: {to_cache_mask}")
        print(f"cached_elements: {cached_elements}")
        print(f"positions: {positions}")
        print(f"cache_positions: {cache_positions}")
